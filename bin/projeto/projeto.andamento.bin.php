<?php
/**
 * 📄 projeto.andamento.bin.php - Seta um projeto como Andamento
 * 🧭 Sistema: SGTopo
...
$PROJETO_->Andamento($_REQUEST['txtChaveRegistro']);
...
if ($this->SISTEMA_['SAIDA']['MODE'] == 'app') {
    ...
    $this->SISTEMA_['ENTIDADE']['PROJETO']['MENSAGEM']['SUCESSO']['ANDAMENTO'];
