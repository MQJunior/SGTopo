<?php
/**
 * 📄 projeto.concluir.bin.php - Seta um projeto como Concluido
 * 🧭 Sistema: SGTopo
...
$PROJETO_->Concluir($_REQUEST['txtChaveRegistro']);
...
if ($this->SISTEMA_['SAIDA']['MODE'] == 'app') {
    ...
    $this->SISTEMA_['ENTIDADE']['PROJETO']['MENSAGEM']['SUCESSO']['CONCLUIR'];
