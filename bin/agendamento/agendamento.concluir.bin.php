<?php
/**
 * 📄 agendamento.concluir.bin.php - Define o status do agendamento como concluído
 * 🧭 Sistema: SGTopo
...
$AGENDAMENTO_->Concluir($_REQUEST['txtChaveRegistro']);
...
if ($this->SISTEMA_['SAIDA']['MODE'] == 'app') {
    ...
    $this->SISTEMA_['ENTIDADE']['AGENDAMENTO']['MENSAGEM']['SUCESSO']['CONCLUIR'];
