 ...
 * @name principal
 * @desc
 *   Script que exibe o conteudo principal de acordo com a configura��o
 *
...
if (isset($this->SISTEMA_['CONFIG']['SISTEMA']['GERAL']['LAYOUT_PADRAO'])) {
  ...
  require ($this->SISTEMA_['LAYOUT'] . "../basic/sistema/sistema.principal.layout.php");
