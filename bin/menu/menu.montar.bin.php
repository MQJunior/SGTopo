...
//print_r($this->SISTEMA_['SESSAO']);die();
...
function LimparMenu($p_MENU)
{
  ...
  foreach ($p_MENU as $tmp_MENU) {
    ...
    //die(print_r($tmp_retorno)." = " .__LINE__ . __FILE__ );
  }
  return $tmp_retorno;
}
...
$VAR_PERMISSAO_ENTIDADE_ACAO = array();
if (is_array($tmp_Permissao_Usuario))
  foreach ($tmp_Permissao_Usuario as $tmp_Permissao_EntidadeAcao) {
    ...
    #print("\n\r".$tmp_Permissao_EntidadeAcao['ENTIDADE'] ." - ".$tmp_Permissao_EntidadeAcao['ACAO'] );
  }
