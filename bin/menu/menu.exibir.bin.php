<?php
/**
 * @file sgpadrao.login.bin.php ddfdf
 * @name login
 * @desc
 ...
 * @version    0.0.0 
 * @copyright  Copyright Ã‚Â© 2006, Marcio Queiroz Jr.
 * @package    sgpadrao
 * @subpackage bin
 * @todo       
 *
...
require($this->SISTEMA_['CONFIG']['SISTEMA']['GERAL']['LAYOUT_PADRAO'] . "menu/menu.exibir.layout.php");
