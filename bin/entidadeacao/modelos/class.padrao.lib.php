...
* @name padrao
* @desc
*   Classe para manipulaчуo da entidade padrуo
*
 ...
 */     
  public function Listar($p_Inativos=false,$p_QtdeReg=null){
    ...
    if ($p_Inativos)
      $sql_Condicao = "(1=1)";
    $sql_Listar = "select  Padrao.*
    FROM  ".$this->TBL_PADRAO." as Padrao
      where
        ".$sql_Condicao."
    order by Padrao.NOME ".$sql_QtdReg;
 ...
 */     
  public function PesquisarNome($p_NOME='',$p_Inativos=false,$p_QtdeReg=null){
    ...
    $sql_PesquisarNome = "select  Padrao.*
    FROM  ".$this->TBL_PADRAO." as Padrao
      where
        ".$sql_Condicao."
    order by Padrao.NOME".$sql_QtdReg;
 ...
 */     
  public function Pesquisar($p_CAMPO='NOME',$p_VALOR='',$p_Inativos=false,$p_QtdeReg=null){
    ...
    FROM  ".$this->TBL_PADRAO." as Padrao
      where
        ".$sql_Condicao."
    order by Padrao.".$p_CAMPO.$sql_QtdReg;
