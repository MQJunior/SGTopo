...
//include_once($SISTEMA['INCLUDES']['DIR']['CONFIG'].'SGTopo.db.conf.php');
...
$SISTEMA['CONFIG']['ARQUIVO']['LOCAL']['EXIBIR']                                = '/sistema/www/SGTopo/files/';
isset($_SERVER["SERVER_ADDR"]) ? $SISTEMA['CONFIG']['ARQUIVO']['LOCAL']['LINK'] = 'http://' . $_SERVER["SERVER_ADDR"] . '/SGTopo/files/' : $SISTEMA['CONFIG']['ARQUIVO']['LOCAL']['LINK'] = $SISTEMA['CONFIG']['SISTEMA']['GERAL']['LOCAL'] . 'files/';
