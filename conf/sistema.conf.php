...
$SISTEMA['CONFIG']['SISTEMA']['INFO']['SISTEMA_NOME']      = 'SysTopo';                                                    // Define o nome do Sistema
$SISTEMA['CONFIG']['SISTEMA']['INFO']['SISTEMA_NOMECURTO'] = 'SyT';                                                        // Define o nome do Sistema
$SISTEMA['CONFIG']['SISTEMA']['GERAL']['NOME']             = 'SGTOPO';                                                     // Define o nome do Sistema
...
$SISTEMA['CONFIG']['SISTEMA']['GERAL']['LAYOUT_PADRAO']    = $SISTEMA['CONFIG']['SISTEMA']['GERAL']['LOCAL'] . "SGTopo/Layout/"; // Define o diretório do LAYOUT_PADRÃO
