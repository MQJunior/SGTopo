 ...
 * @desc
 *   Arquivo com as legendas dos campos, formul�rips, mensagens e bot�es. <idioma portugu�s-Brasil>
 *
...
$this->SISTEMA_['ENTIDADE']['PADRAO']['MENSAGEM']['SUCESSO']['EXCLUSAO'] = "Registro exclu�do com sucesso!";
...
//----------------------//
$SysRtl_Padrao_Campos_NOME = "Nome";
$SysRtl_Padrao_Campos_DESCRICAO = "Descrição";
$SysRtl_Padrao_Campos_TIPO = "Tipo";
$SysRtl_Padrao_Campos_VALOR = "Valor";
$SysRtl_Padrao_Campos_DATA = "Data";
$SysRtl_Padrao_Campos_ESCOLHA = "Escolha";
