...
$this->SISTEMA_['ENTIDADE']['SCRIPTS']['MENSAGEM']['SUCESSO']['MENSAGEM'] = "Informações salva com sucesso!";
$this->SISTEMA_['ENTIDADE']['SCRIPTS']['MENSAGEM']['SUCESSO']['EXCLUSAO'] = "Registro excluído com sucesso!";
...
$SysRtl_Scripts_Campos_CODIGO ="Código";
$SysRtl_Scripts_Campos_SESSAO ="Sessão";
$SysRtl_Scripts_Campos_DATACRIACAO ="Dt Criação";
$SysRtl_Scripts_Campos_USUARIO ="Usuário";
...
$SysRtl_Scripts_Alterar_Conteudo_Titulo = "Alteração Scripts";
      //----------------------//

      /* Legendas do formulário executar */
$SysRtl_Scripts_Alterar_Cabecalho_Titulo = "Scripts";
