...
class Sessao
{
  ...
  */
        ...
        if ($tmpSID == null) {
            ...
            if ($this->getExpirado()) {
                ...
                if ($this->SISTEMA_['SAIDA']['MODE'] == 'app') {
                    $this->SISTEMA_['ERROR']['SESSAO']['MENSAGEM'] = "SESSAO INVÁLIDA!";
                    http_response_code(200);
                    header('Content-Type: application/json');
                    $SaidaErro['SysError'] = $this->SISTEMA_['ERROR'];
                    $SAIDA_Sistema         = json_encode($SaidaErro, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    ...
    */
    ...
    {
        if ($this->Nome == '') {
            die("� Necess�rio informar o nome da Sessão.");
        }
