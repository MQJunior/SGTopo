...
CREATE TABLE IF NOT EXISTS `TBL_SYS_ACOES` (
  ...
  CONSTRAINT `TBL_SYS_ACOES_ENTIDADE` FOREIGN KEY (`ENTIDADE`) REFERENCES `TBL_SYS_ENTIDADES` (`NOME`)
...
CREATE TABLE IF NOT EXISTS `TBL_SYS_LOGS` (
  ...
  KEY `ACAO` (`ACAO`),
  CONSTRAINT `TBL_SYS_LOGS_USUARIO` FOREIGN KEY (`USUARIO`) REFERENCES `TBL_USUARIOS` (`CODIGO`),
...
CREATE TABLE IF NOT EXISTS `TBL_SYS_MENUS` (
  ...
  CONSTRAINT `TBL_SYS_MENUS_ENTIDADEACAO` FOREIGN KEY (`ENTIDADE_ACAO`) REFERENCES `TBL_SYS_ACOES` (`CODIGO`),
  CONSTRAINT `TBL_SYS_MENUS_USUARIO` FOREIGN KEY (`USUARIO`) REFERENCES `TBL_USUARIOS` (`CODIGO`),
  CONSTRAINT `TBL_SYS_MENUS_MENUPAI` FOREIGN KEY (`MENU_PAI`) REFERENCES `TBL_SYS_MENUS` (`CODIGO`),
...
CREATE TABLE IF NOT EXISTS `TBL_SYS_PERMISSOES` (
  ...
  CONSTRAINT `TBL_SYS_PERMISSOES_USUARIO` FOREIGN KEY (`USUARIO`) REFERENCES `TBL_USUARIOS` (`CODIGO`),
  CONSTRAINT `TBL_SYS_PERMISSOES_ACAO` FOREIGN KEY (`ACAO`) REFERENCES `TBL_SYS_ACOES` (`CODIGO`),
