<?php
/**
* @file scripts.consultar.layout.php
...
foreach ($SysOpt_Scripts_TIPO['OPCOES'] as $VAR_OPCOES_TIPO)
  if ($VAR_OPCOES_TIPO['VALOR']==$VAR_SCRIPTS_TIPO)
    $VAR_SCRIPTS_TIPO= $VAR_OPCOES_TIPO['LEGENDA'];
...
$btn_executar = "";
if($PERMISSAO_->ChecarPermissao($this->SISTEMA_['SESSAO']['USUARIO']['CODIGO'], 'SCRIPTS', 'EXECUTAR'))
  $btn_executar = "<a href=\"javascript::;\" class=\"btn btn-sm btn-success\" onclick=\"PesquisaDados('.?XMLHTML=true&SysEntidade=SCRIPTS&SysEntidadeAcao=EXECUTAR&SID=$SistemaSessaoUID','','DIV_CONTEUDO','FORM_SCRIPTS_CONSULTAR')\"><i class=\"fa fa-gear\"></i> <b>$SysRtl_Btn_Executar</b></a>";
