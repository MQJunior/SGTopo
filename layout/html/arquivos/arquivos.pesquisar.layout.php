<?php
/**
 * 📄 arquivos.pesquisar.layout.php - Formulário de pesquisa com tabela de dados
...
$tmpMostrarInativos = "";
if (
    ($PERMISSAO_->ChecarPermissao($this->SISTEMA_['SESSAO']['USUARIO']['CODIGO'], 'ARQUIVOS', 'ATIVAR'))
    ||
    ($PERMISSAO_->ChecarPermissao($this->SISTEMA_['SESSAO']['USUARIO']['CODIGO'], 'ARQUIVOS', 'DESATIVAR'))
) {
    ...
    "   <div class=\"col-md-12\">
      <div class=\"box box-$SistemaLayoutCor\">
        <div class=\"box-header\">
          <h3 class=\"box-title\">$SysRtl_Arquivos_Pesquisar_Conteudo_Titulo</h3>
          <div class=\"btn-group pull-right\">
            $btn_novo
          </div>
        </div>
        <div class=\"box-body\">
          <form class=\"form-horizontal\" method=\"post\" action=\"javascript::;\" id=\"FORM_ARQUIVOS_PESQUISAR\" name=\"FORM_ARQUIVOS_PESQUISAR\" >
...
$this->SISTEMA_['SAIDA']['EXIBIR'] .= "</select>
              ...
              <div class=\"col-sm-8\">
                ...
                <div class=\"input-group input-group-sm\">
                  ...
                  <input type=\"text\" class=\"form-control\" name=\"TXT_ARQUIVOS_PESQUISAR\" ID=\"TXT_ARQUIVOS_PESQUISAR\">
                  <span class=\"input-group-btn\">
                    <a href=\"javascript::;\" name=\"BTN_PESQUISAR\" id=\"BTN_PESQUISAR\" class=\"btn btn-sm btn-$SistemaLayoutCor\" onclick=\"PesquisaDados('.?XMLHTML=true&SysEntidade=ARQUIVOS&SysEntidadeAcao=PESQUISAR&SID=$SistemaSessaoUID','','TABELA_ARQUIVOS_PESQUISAR','FORM_ARQUIVOS_PESQUISAR')\"><i class=\"fa fa-search\"></i> <b>$SysRtl_Btn_Pesquisar</b></a>
          ...
          <div class=\"form-group\">
            <table id=\"TABELA_ARQUIVOS_PESQUISAR\" class=\"table table-hover\" >
              <thead>
                <tr>";
foreach ($EntidadeCampos as $tmpCampos) {
    if ($tmpCampos['EXIBIR']) {
...
<script language=\"text/javascript\">
  LBL_TITULO.innerText='$SysRtl_Arquivos_Pesquisar_Cabecalho_Titulo';
  LBL_SUBTITULO.innerText='$SysRtl_Arquivos_Pesquisar_Cabecalho_Subtitulo';
  LBL_SUBTITULO_LOCAL.innerText='$SysRtl_Arquivos_Pesquisar_Cabecalho_Subtitulo';
  LBL_ARVORE_LOCAL.innerHTML ='<a href=\"javascript::;\"><i class=\"fa $SysRtl_Arquivos_Pesquisar_Cabecalho_Icone\"></i> $SysRtl_Arquivos_Pesquisar_Cabecalho_Titulo</a>';
</script>";
