<?php
/**
 * 📄 cidade.consultar.layout.php - Layout para o formulário de consulta
...
if ($VAR_CIDADE_REG_ATIVO == '1') {
    $VAR_CIDADE_REG_ATIVO = true;
    $VAR_REGISTRO_INATIVO = "";
} else {
    $VAR_CIDADE_REG_ATIVO = false;
...
if ($PERMISSAO_->ChecarPermissao($this->SISTEMA_['SESSAO']['USUARIO']['CODIGO'], 'LOGATIVIDADE', 'INFORMACAO')) {
    $tmpLogAtividade = "<a href=\"javascript::;\" onclick=\"PesquisaDados('.?XMLHTML=true&SysEntidade=LOGATIVIDADE&SysEntidadeAcao=INFORMACAO&txtChaveRegistro=$VAR_CIDADE_CODIGO&TXT_LOGATIVIDADE_ENTIDADE=CIDADE&SID=$SistemaSessaoUID','','DIV_LOG_INFO',null)\">
...
if ($PERMISSAO_->ChecarPermissao($this->SISTEMA_['SESSAO']['USUARIO']['CODIGO'], 'LOGATIVIDADE', 'VER')) {
    $tmpLogVer = "<h6 class=\"text-muted\">
            $tmpLogAtividade
            <i>$SysRtl_Cidade_Campos_USUARIO_NOME:</i><b> $VAR_CIDADE_USUARIO_NOME</b> - <i>$SysRtl_Cidade_Campos_DATACRIACAO:</i><b> $VAR_CIDADE_DATACRIACAO</b></h6>";
}
...
$btn_editar = "";
if ($PERMISSAO_->ChecarPermissao($this->SISTEMA_['SESSAO']['USUARIO']['CODIGO'], 'CIDADE', 'ALTERAR')) {
    $btn_editar = "<a href=\"javascript::;\" class=\"btn btn-sm btn-$SistemaLayoutCor\" onclick=\"PesquisaDados('.?XMLHTML=true&SysEntidade=CIDADE&SysEntidadeAcao=ALTERAR&SID=$SistemaSessaoUID','','DIV_CONTEUDO','FORM_CIDADE_CONSULTAR')\"><i class=\"fa fa-edit\"></i> <b>$SysRtl_Btn_Editar</b></a>";
}
...
<div class=\"col-md-8 col-sm-offset-2\">
  <div class=\"box box-$SistemaLayoutCor\" id=\"DIV_FORM_CIDADE\">
    <div class=\"box-header with-border\">
      <h3 class=\"box-title\">$SysRtl_Cidade_Consultar_Conteudo_Titulo</h3>
    ...
    <div class=\"box-body\">
      <form class=\"form-horizontal\" method=\"post\" action=\"javascript::;\" id=\"FORM_CIDADE_CONSULTAR\" name=\"FORM_CIDADE_CONSULTAR\" onSubmit=\"\">
        <input type=\"hidden\" id=\"SysEntidade\" name=\"SysEntidade\" value=\"CIDADE\">
...
<script language=\"text/javascript\">
  LBL_TITULO.innerText='$SysRtl_Cidade_Consultar_Cabecalho_Titulo';
  LBL_SUBTITULO.innerText='$SysRtl_Cidade_Consultar_Cabecalho_Subtitulo';
  LBL_SUBTITULO_LOCAL.innerText='$SysRtl_Cidade_Consultar_Cabecalho_Subtitulo';
  LBL_ARVORE_LOCAL.innerHTML ='<a href=\"javascript::;\"><i class=\"fa $SysRtl_Cidade_Consultar_Cabecalho_Icone\"></i> $SysRtl_Cidade_Consultar_Cabecalho_Titulo</a>';
</script>";
