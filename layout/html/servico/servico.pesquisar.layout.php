<?php
/**
 * 📄 servico.pesquisar.layout.php - Formulário de pesquisa com tabela de dados
...
$tmpMostrarInativos = "";
if (
    ($PERMISSAO_->ChecarPermissao($this->SISTEMA_['SESSAO']['USUARIO']['CODIGO'], 'SERVICO', 'ATIVAR'))
    ||
    ($PERMISSAO_->ChecarPermissao($this->SISTEMA_['SESSAO']['USUARIO']['CODIGO'], 'SERVICO', 'DESATIVAR'))
) {
    ...
    "   <div class=\"col-md-12\">
      <div class=\"box box-$SistemaLayoutCor\">
        <div class=\"box-header\">
          <h3 class=\"box-title\">$SysRtl_Servico_Pesquisar_Conteudo_Titulo</h3>
          <div class=\"btn-group pull-right\">
            $btn_novo
          </div>
        </div>
        <div class=\"box-body\">
          <form class=\"form-horizontal\" method=\"post\" action=\"javascript::;\" id=\"FORM_SERVICO_PESQUISAR\" name=\"FORM_SERVICO_PESQUISAR\" >
...
$this->SISTEMA_['SAIDA']['EXIBIR'] .= "</select>
              ...
              <div class=\"col-sm-8\">
                ...
                <div class=\"input-group input-group-sm\">
                  ...
                  <input type=\"text\" class=\"form-control\" name=\"TXT_SERVICO_PESQUISAR\" ID=\"TXT_SERVICO_PESQUISAR\">
                  <span class=\"input-group-btn\">
                    <a href=\"javascript::;\" name=\"BTN_PESQUISAR\" id=\"BTN_PESQUISAR\" class=\"btn btn-sm btn-$SistemaLayoutCor\" onclick=\"PesquisaDados('.?XMLHTML=true&SysEntidade=SERVICO&SysEntidadeAcao=PESQUISAR&SID=$SistemaSessaoUID','','TABELA_SERVICO_PESQUISAR','FORM_SERVICO_PESQUISAR')\"><i class=\"fa fa-search\"></i> <b>$SysRtl_Btn_Pesquisar</b></a>
          ...
          <div class=\"form-group\">
            <table id=\"TABELA_SERVICO_PESQUISAR\" class=\"table table-hover\" >
              <thead>
                <tr>";
foreach ($EntidadeCampos as $tmpCampos) {
    if ($tmpCampos['EXIBIR']) {
...
<script language=\"text/javascript\">
  LBL_TITULO.innerText='$SysRtl_Servico_Pesquisar_Cabecalho_Titulo';
  LBL_SUBTITULO.innerText='$SysRtl_Servico_Pesquisar_Cabecalho_Subtitulo';
  LBL_SUBTITULO_LOCAL.innerText='$SysRtl_Servico_Pesquisar_Cabecalho_Subtitulo';
  LBL_ARVORE_LOCAL.innerHTML ='<a href=\"javascript::;\"><i class=\"fa $SysRtl_Servico_Pesquisar_Cabecalho_Icone\"></i> $SysRtl_Servico_Pesquisar_Cabecalho_Titulo</a>';
</script>";
